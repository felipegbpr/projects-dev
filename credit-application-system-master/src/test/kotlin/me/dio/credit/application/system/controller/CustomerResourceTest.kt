...
class CustomerResourceTest {
  ...
  fun `should update a customer and return 200 status`() {
    ...
    mockMvc.perform(
      ...
      .andExpect(MockMvcResultMatchers.status().isOk)
      .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("FelipeUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("GomesUpdate"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("28475934625"))
      .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("felipe@email.com"))
  ...
  private fun builderCustomerUpdateDto(
    firstName: String = "FelipeUpdate",
    lastName: String = "GomesUpdate",
